...
public class GetPage {
    ...
    public static String navBar = "\n"
            ...
            + "        <span class=\"icon-bar\"></span>                        \n"
            + "      </button>\n"
            + "      <a class=\"navbar-brand\" href=\"/ControledeEstoques/jsp/Menu/menuPrincipal.jsp\">SGCE</a>\n"
            + "    </div>\n"
            ...
            + "        <li><a href=\"/ControledeEstoques/index.jsp\"><span class=\"glyphicon glyphicon-log-in\"></span> Sair</a></li>\n"
            + "      </ul>\n"
            + "    </div>\n"
            + "  </div>\n"
            + "</nav>";
    ...
    private static String footer = "<footer class=\"container-fluid text-center\">\n"
            + "  <p>SGCE <b>S</b>istema <b>G</b>erenciador e <b>C</b>ontrolador de <b>E</b>stoques</p>\n"
            + "</footer>\n"
            + "\n"
            + " ";
