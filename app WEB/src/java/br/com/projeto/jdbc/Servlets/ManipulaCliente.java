 ...
 * @author danilo2
 */
public class ManipulaCliente extends HttpServlet {
...
/*
    ...
    @Override
    protected void doDelete(HttpServletRequest request, HttpServletResponse res) throws ServletException, IOException {
            String n = "input";
    }
    ...
    @Override
    protected void doPut(HttpServletRequest request, HttpServletResponse res) throws ServletException, IOException {
            String n = "input";
    }
